...
class Register : AppCompatActivity() {
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    Log.d("Register", "successfully create user with id = $firebaseid")
    ...
    private fun uploadDataToDatabase() {
        ...
        val userr = user(
            ...
            "offline",
            username_Register.text.toString().toLowerCase(),
        ...
        ref.setValue(userr).addOnCompleteListener {
            if (it.isSuccessful) {
                ...
                Log.d("Register", "successfully update user data to database")
